...
EVA支持OpenAI接口形式的LLM，可以是Ollma、vLLM拉起的本地模型，也可以是DeepSeek、OpenAI等官网API。因此，你可以直接修改代码中的`VLLM_BASE_URL`, `MODEL_NAME`, `EVA_API_KEY`变量为对应的服务，其中`EVA_API_KEY`支持从环境变量导入
